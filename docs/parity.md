...
- Configured SUDP owner/visitor STUN mapping discovery with per-socket candidate reuse, IPv4/IPv6 XOR-MAPPED-ADDRESS parsing, and transaction validation.
