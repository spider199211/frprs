...
| XTCP / P2P | Basic implemented | NAT controller, candidate exchange, async notifications, XTCP direct data plane, SUDP direct data plane, probing/retry, and fallback are implemented. Complex NAT negotiation remains. |
